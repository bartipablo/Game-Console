...
private:
    KeySet* generateLowerCaseLettersWithNumber() {
        KeySet* lowercaseClassicKeysWithNumbers = new KeySet();
    ...
    KeySet* generateUpperCaseLettersWithNumber() {
        KeySet* uppercaseClassicKeysWithNumbers = new KeySet();
