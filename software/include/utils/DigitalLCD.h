...
public:
     ...
     * @param defaultRotation The default rotation of the LCD display.
     */
    static void init(const Arduino_ESP32SPI* bus, const int TFT_RESET, const int defaultRotation=3);
